...
// Add Doctor Slots
exports.addDoctorSlots = async (reqUserId, { date, slots }) => {
...
// Get Doctor Slots
exports.getDoctorSlots = async (reqUserId) => {
  const user = await User.findById(reqUserId);
...
exports.updateDoctorSlotsAfterBooking = async ({ doctorId, date, time }) => {
...
exports.getDoctorsBySpecialization = async (specialization) => {
...
exports.deleteSingleTimeSlot = async (reqUserId, { date, time }) => {
...
exports.deleteAllSlotsForDate = async (reqUserId, { date }) => {
